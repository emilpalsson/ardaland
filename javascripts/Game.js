...
SI.Game.prototype.checkEndGame = function () {
	if(this.enemies.ships.length == 0) {
		...
		this.newGamePrompt('Du vann, men du förlorar ändå. För nu får inte staten in några skattepengar från spelbolagen så du får ingen vård, dina barn kan inte gå i skolan och ingen kommer att laga de där hålen i vägen på väg till ditt jobb. Bra jobbat. Verkligen.');
	}
